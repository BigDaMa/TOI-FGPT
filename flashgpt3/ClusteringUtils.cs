...
namespace FlashGPT3
{
    internal static partial class ClusteringUtils
    {
        ...
        /// <returns></returns>
        /// <remarks>from MS, correct</remarks>
        internal static List<List<string>> ClusterGreedy(List<List<string>> options, bool print = false)
        {
            ...
            //XmlSerializer ser = new XmlSerializer(typeof(List<List<string>>));
            //// write
            //dynamic stream;
            //if (File.Exists("greedy.xml"))
            //{
            //    stream = File.AppendText("greedy.xml");
            //}
            //else
            //{
            //    stream = File.Create("greedy.xml");
            //}
            //using (stream)
            //{
            //    ser.Serialize(stream, clusters); // your instance
            //}
